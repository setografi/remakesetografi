...
export default function ButtonProfile() {
  ...
  return (
    <div className="flex text-center gap-6 p-1">
      <a
        className={`w-full rounded-xl p-3 font-medium text-sm cursor-pointer transition duration-300 hover:bg-SkyBlue hover:text-CatalinaBlue ${
          buttonState.follow
            ? "bg-SkyBlue text-CatalinaBlue"
            : "bg-LightBlue text-DarkBlueGrey"
        }`}
      ...
      <a className="w-24 p-3 text-sm cursor-pointer">
        <div className="text-DarkBlueGray transition duration-700 hover:rotate-180 hover:scale-125">
